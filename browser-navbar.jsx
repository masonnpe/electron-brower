...
var BrowserNavbar = React.createClass({
  render: function() {
    return <div id="browser-navbar">
      <BrowserNavbarBtn title="主页" icon="home fa-lg" onClick={this.props.onClickHome} disabled={!this.props.page.canGoBack} />
      ...
      <BrowserNavbarBtn title="重新加载" icon="refresh" onClick={this.props.onClickRefresh} disabled={!this.props.page.canRefresh} />
